...
function getTimeGreeting() {
  ...
  if (hour >= 17 && hour < 21)
    return "🌇 Good Evening! શુભ સાંજ! માધવ સોલારમ຾ં આપનું સ્વ຾ગત!";
  return "🌙 Good Night! શુભ રાત્રી! મ຾ધવ સોલ຾રમ຾ં આપનું સ્વ຾ગત!";
}
...
export default function WhatsAppChatbot() {
  ...
  const handleSend = () => {
    ...
    // Auto-reply with both WhatsApp links after short delay
    setTimeout(() => {
      ...
      <AnimatePresence>
        {isOpen && (
          ...
          >
            ...
            {/* Quick replies */}
            <div className="bg-white border-t border-gray-200 p-2 grid grid-cols-2 gap-1.5">
              <a
